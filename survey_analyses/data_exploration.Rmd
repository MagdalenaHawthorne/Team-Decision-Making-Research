...
survey_data %>% mutate(indiv_team_tenure = indiv_team_tenure %>% fct_infreq) %>% 
...
survey_data %>% 
  count(agile_method) 
# percent using an agile method [REMINDER: TRUE is interpreted as 1, FALSE as 0]
survey_data %>% 
...
# Anteil weiblicher Angestellter bei SAP im Jahr 2018: 33 % 
```
## work experience
