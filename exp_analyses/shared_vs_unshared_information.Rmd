...
```
# Compute & test measures for shared vs. unshared information by condition
...
```
### calculate shared information bias per condition (mentioning rate for shared inf. divided by sum of mentioning rate for unshared and shared)
...
```
# Does the ration of shared vs. unshared information predict decision quality?
...
```
# Shared information biases per condition
